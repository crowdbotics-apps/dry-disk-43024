"""
Django settings for dry_disk_43024 project.
...
ROOT_URLCONF = 'dry_disk_43024.urls'
...
WSGI_APPLICATION = 'dry_disk_43024.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_disk_43024 API",
    "DESCRIPTION": "API documentation for dry_disk_43024 App",
    "VERSION": "v1",
}
